class TacBF
{
        class Supply
        {
                ...
                class CargoCollections
                {
                        class statics_west {
                                transportClear = 1;
                                cargo[] = {{"RHS_M2StaticMG_D", 4, 8}, {"RHS_M252_D", 0, 4}, {"RHS_TOW_TriPod_D", 2, 6}, {"TB_Box_West_Mines_F", 4, 0}};
                        };
                        class statics_east {
                                transportClear = 1;
                        ...
                        class statics_res {
                                transportClear = 1;
                                cargo[] = {{"RDS_DSHkM_Mini_TriPod_CSAT", 6, 12}, {"rhs_SPG9M_MSV", 2, 4}, {"RHS_ZU23_MSV", 0, 6}, {"TB_Box_East_Mines_F", 4, 0}};
                        };
			class rds_westFO {
				transportClear = 1;
				cargo[] = {{"RHS_M2StaticMG_D", 2, 4}, {"RHS_M252_D", 0, 0}};
			};
